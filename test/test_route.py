...
INST   = ["department", "general"]
GEN_BROAD = ["general", "campus", "program", "department", "student_life",
...
ROUTING_CASES = [
    ...
    ("en", "I want to meet my advisor about research.", GEN_BROAD, None, None, False,
    ...
    ("es", "¿Cómo solicito la admisión?", ADM, None, None, False, "es admissions (admisión)"),
    ("fr", "Comment postuler pour l'admission ?", ADM, None, None, False, "fr admissions"),
...
DETECTOR_CASES = [
    ...
    ("guess_ui_language", "ui", "Estoy muy estresado con mis clases y me siento abrumado",
     "Spanish", False, "distress sentence with no '¿'/function-word markers (the bug)"),
    ("guess_ui_language", "ui", "Estou muito estressado e preciso de ajuda", "Portuguese", False,
     "Portuguese statement, no question markers"),
    ("guess_ui_language", "ui", "Je suis très stressé, j'ai besoin d'aide", "French", False,
     "French statement, no question markers"),
    ...
    ("guess_ui_language", "ui", "what class is cop 3003", "English", False,
     "short lowercase English query must resolve to English (the Spanish-drift bug)"),
    ("guess_ui_language", "ui", "when does it happen", "English", False,
     "short ambiguous follow-up must not flip to Dutch"),
    ("guess_ui_language", "ui", "tell me more", "English", False,
     "short ambiguous follow-up must not flip to Italian"),
]
